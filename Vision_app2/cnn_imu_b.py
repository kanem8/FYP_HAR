...
dataset_train = pd.read_csv('/data/mark/NetworkDatasets/vision_app2_b/Train/figure_labels.csv', ',', header=0)
dataset_pickle = '/data/mark/NetworkDatasets/baseline/pamap2.data'

train_path = '/data/mark/NetworkDatasets/vision_app2_b/Train/'
...
dataset_validation = pd.read_csv('/data/mark/NetworkDatasets/vision_app2_b/Validation/figure_labels.csv', ',', header=0)

Validation_path = '/data/mark/NetworkDatasets/vision_app2_b/Validation/'
...
def train(optimizer, model, num_epochs, first_epoch=1):
    ...
    for epoch in range(first_epoch, first_epoch + num_epochs):
        ...
        if wf1 > best_wf1:
            best_wf1 = wf1
            best_y_pred = y_pred
            torch.save(model.state_dict(), '/data/mark/saved_models/va1/cnn_imu_2_b.pt')
...
if __name__ == '__main__':
    ...
    figcon.savefig('/home/mark/Repo/FYP_HAR/Vision_app2/Confusion_graphs/confusion_cnn_imu_smallT.jpg')