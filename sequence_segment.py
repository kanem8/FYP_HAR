...
def sliding_window_HR(X_data, y_data, T, s, target_filepath):
...
#     rows = np.arange(0, range(X_data.shape[0])-100, s)
    ...
    for j in rows:
        ...
        fig_HR, axes_HR = plt.subplots(nrows=1, ncols=1, sharex=True, sharey=False)
        plt.subplots_adjust(left=0.03, bottom=0.03, right=0.97, top=0.97, wspace=None, hspace=None)
...
#             axes[2].axis('off')
        ...
        x_dataframe.iloc[j:(j+T)].plot(ax=axes_HR, y=0, legend=None)
        axes_HR.axis('off')
        ...
        image_HR = target_filepath + "HR_Sensor/fig" + str(count_figures) + ".jpg"
        fig_HR.savefig(image_HR)
    ...
    print('Finished Plots for ' + target_filepath)
    print('Number of plots per IMU: {0}'.format(str(count_figures)))
    print('Total number of plots for this set of data: {0}'.format(str(count_figures*4)))    


    
    
def cnn_sliding_window(X_data, y_data, T, s, target_filepath):
...
#             axes[2].axis('off')
        ...
        count_figures += 1
        image_IMU2 = target_filepath + "fig" + str(count_figures) + ".jpg"
        fig_IMU2.savefig(image_IMU2) 
        writer.writerow([('fig' + str(count_figures)), str(int(y_data[label_idx]))])
        
        count_figures += 1
        image_IMU3 = target_filepath + "fig" + str(count_figures) + ".jpg"
        fig_IMU3.savefig(image_IMU3)
        writer.writerow([('fig' + str(count_figures)), str(int(y_data[label_idx]))])
    ...
    print('Finished Plots for ' + target_filepath)
    print('Number of plots in set: {0}'.format(str(count_figures)))




def cnn_sliding_window_HR(X_data, y_data, T, s, target_filepath):
...
#             axes[2].axis('off')
        ...
        count_figures += 1
        image_HR = target_filepath + "fig" + str(count_figures) + ".jpg"
        fig_HR.savefig(image_HR)
        writer.writerow([('fig' + str(count_figures)), str(int(y_data[label_idx]))])
