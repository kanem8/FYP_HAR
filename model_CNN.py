...
train_loader_imu1 = DataLoader(training_set_imu1, batch_size=20, num_workers=4, shuffle=True)
...
Validation_loader_imu1 = DataLoader(Validation_set_imu1, batch_size=20, num_workers=4, shuffle=False)
